<template>
  <nav class="text-primary-900 sticky top-0 inset-x-0 z-50 lg:relative lg:h-24 min-h-full flex items-center select-none max-w-full">
    <div class="top-0 inset-x-0 z-50 container mx-auto flex flex-wrap justify-between items-center py-3.5 lg:my-3 px-10 lg:rounded-lg" :class="fixedNavbar">
      ...
      <div class="flex items-center md:order-2">
        <button data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
      ...
      <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium" v-for="link in links">
          <li>
            <a
              :href="'#'+link"
              class="block my-2 mx-4 text-lg font-normal border-b-2 pb-0.5 lg:hover:border-black"
